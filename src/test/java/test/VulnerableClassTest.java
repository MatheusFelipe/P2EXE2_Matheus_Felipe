...
public class VulnerableClassTest {
	...
	public void nullFILENAMEtest_expectsIllegalArgumentException() throws FileNotFoundException {
	...
	@Test(expected = IllegalArgumentException.class)  
	public void FILENAMEwithPATHtoSystemFiles_expectsIllegalArgumentException() throws FileNotFoundException {
	...
	@Test(expected = IllegalArgumentException.class)  
	public void FILENAMEwithEscapeSequences_expectsIllegalArgumentException() throws FileNotFoundException {
	...
	@Test(expected = IllegalArgumentException.class)  
	public void FILENAMEwithProhibitedExtension_expectsIllegalArgumentException() throws FileNotFoundException {
	...
	@Test(expected = IllegalArgumentException.class)  
	public void TypoFILENAME_expectsIllegalArgumentException() throws FileNotFoundException {
	...
	@Test(expected = IllegalArgumentException.class) 
	public void CorrectFILENAME_UserTypo_expectsIllegalArgumentException() throws FileNotFoundException {
	...
	@Test  
	public void CorrectFILENAME_UserTypesR() throws FileNotFoundException {
	...
	public void NonexistentFILENAME_UserTypesR_expectsFileNotFoundException() throws FileNotFoundException {
	...
	@Test
	public void CorrectFILENAME_UserTypesW() throws FileNotFoundException {
